class tokenReport:
    def __init__(self, tokens):      
        ...
        html = open("template/reportes/reporte_Tokens.html", "w")
        ...
        <div class="container">
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <h1 style="color: white; font-size:120px; text-align: center; font-style: italic; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; text-transform:uppercase">Tokens</h1>
                </div>
            </div>
            </div>
        </div>
